...
export const metadata = {
    ...
    description: "Accelerate your professional trajectory with CareerPilot AI. Parse resumes, generate skill gap roadmaps, simulate interviews, and extract career paths using modern intelligence.",
};
