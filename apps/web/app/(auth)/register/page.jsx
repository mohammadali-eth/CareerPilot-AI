...
export default function RegisterPage() {
    ...
    if (successData) {
        ...
        <div className="w-full max-w-md space-y-6 glass-panel p-8 rounded-2xl shadow-premium border border-emerald-500/20 text-center">
          ...
          {successData.verification_token && (<div className="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-lg text-left text-xs font-mono space-y-2">
              <p className="text-emerald-400 font-semibold">
                Simulated Verification Link:
              </p>
              <Link href={`/verify-email?token=${successData.verification_token}`} className="text-primary hover:underline break-all block">
        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input id="first_name" type="text" className={`mt-1 block w-full px-4 py-2 bg-background border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm ${errors.first_name
            ? "border-destructive focus:ring-destructive/50"
            : "border-input"}`} {...register("first_name")}/>
            ...
            <div>
              ...
              <input id="last_name" type="text" className={`mt-1 block w-full px-4 py-2 bg-background border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm ${errors.last_name
            ? "border-destructive focus:ring-destructive/50"
            : "border-input"}`} {...register("last_name")}/>
          ...
          <div>
            ...
            <input id="password" type="password" className={`mt-1 block w-full px-4 py-2 bg-background border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm ${errors.password
            ? "border-destructive focus:ring-destructive/50"
